"""Switch platform for swiss_meteo_warnings."""
...
class SwissMeteoWarningsSwitch(SwissMeteoWarningsEntity, SwitchEntity):
    """swiss_meteo_warnings switch class."""
